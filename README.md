...
<h3>Domestic Conference</h3>
  <ul>
    <li>박성우, <strong>최문봉</strong>, 김대훈, 정종균, 황인준. "동물 소리 분리를 위한 주의집중 게이트 기반의 BioCPPNet", Korean DataBase Conference, 2023</li>
    <li><strong>최문봉</strong>, 김은빈, 문재욱, 황인준. "문서 검색 엔진의 성능 향상을 위한 신조어 사전 구축 기법", 한국정보과학회 한국소프트웨어종합학술대회 학술발표논문집, 2023</li>
